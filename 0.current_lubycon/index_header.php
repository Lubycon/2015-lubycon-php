...
<div id="wrapper"> 
    ...
    <aside id="mb-menu_panel" class="visible-mb"><!--mobile panel menu-->
        ...
        <ul class="mb-menu_group">
            <li class="mb-menu_list">
                <i class="fa fa-font fa-1x"></i><a href="./php/contents/contents_page.php&3=artwork">Artwork</a>
            </li>
            <li class="mb-menu_list">
                <i class="fa fa-square fa-1x"></i><a href="./php/contents/contents_page.php&3=vector">Vector</a>
            </li>
            <li class="mb-menu_list">
                <i class="fa fa-cube fa-1x"></i><a href="./php/contents/contents_page.php&3=3d">3D Model</a>
            </li>
        </ul>
        <ul class="mb-menu_group">
            <li class="mb-menu_list">
                <i class="fa fa-pencil fa-1x"></i><a href="./php/creators_page/creators.php">Creator</a>
            </li>
            <li class="mb-menu_list">
            	<i class="fa fa-comments-o fa-1x"></i><a href="./php/community/community_page.php&3=forum">Forum</a>
            </li>
        </ul>
        <ul class="mb-menu_group">
            <li class="mb-menu_list">
                <i class="fa fa-tachometer fa-1x"></i><a href="./php/personal_page/personal_page.php&3=dashboard">Dashboard</a>
            </li>
            <li class="mb-menu_list">
                <i class="fa fa-line-chart fa-1x"></i><a href="./php/personal_page/personal_page.php&3=insight">Insight</a>
            </li>
            <li class="mb-menu_list">
                <i class="fa fa-gear fa-1x"></i><a href="./php/personal_page/personal_page.php&3=account_setting">Account Setting</a>
            </li>
        </ul>
        <ul class="mb-menu_group">
    ...
    <div class="editor_popup fadeInDown animated"> <!-- popup start -->
        ...
        <ul>
            <li>
                <a href="./php/editor/editor&3=artwork">
                <i class="fa fa-font"></i>
                <p>Artwork</p>
                </a>
            </li>
            <li>
                <a href="./php/editor/editor&3=vector">
                <i class="fa fa-stop"></i>
                <p>Vector</p>
                </a>
            </li>
            <li>
                <a href="./php/editor/editor&3=3d">
    ...
    <header class="main_header">
        ...
        <nav id="main_gnb" class="hidden-mb-b">
            <ul id="gnb">
                <li class="bigsub">
                    <a href="./php/contents/contents_page&3=all" class="bigsub_link">
                        Contents
                    </a>
                    <ul class="sub">
                        <li>
                            <a href="./php/contents/contents_page.php?cate=artwork"><i class="fa fa-font fa-1x"></i><p>Artwork</p></a>
                        </li>
                        <li>
                            <a href="./php/contents/contents_page.php&cate=vector"><i class="fa fa-square fa-1x"></i><p>Vector</p></a>
                        </li>
                        <li>
                            <a href="./php/contents/contents_page.php&cate=3d"><i class="fa fa-cube fa-1x"></i><p>3D Model</p></a>
                        </li>
                ...
                <li class="bigsub">
                    ...
                    <ul class="sub">
                        <li><!--ranking-->
                            <a href="./php/creators_page/creators.php"><i class="fa fa-pencil fa-1x"></i><p>Creators</p></a>
                        </li>
                        <li><!--forum-->
                            <a href="./php/community/community_page.php&cate=forum"><i class="fa fa-comments-o fa-1x"></i><p>Forum</p></a>
                        </li>
                        <li><!--tutorial-->
                            <a href="./php/community/community_page.php&cate=tutorial"><i class="fa fa-book fa-1x"></i><p>Tutorial</p></a>
                        </li>
                        <li><!--Q&A-->
                            <a href="./php/community/community_page.php&cate=qna"><i class="fa fa-question fa-1x"></i><p>Q&amp;A</p></a>
                        </li>
        ...
        <div id="after_signin" class="hidden-mb-b">   <!-- after sign in -->
            ...
            <ul>
                ...
                <div class="userMenuGroup">
                    <li><a href="./php/personal_page/personal_page&3=dashboard">
                        <i class="fa fa-tachometer fa-1x"></i>Dashboard
                    </a></li>
                    <li><a href="./php/personal_page/personal_page&3=my_contents">
                        <i class="fa fa-picture-o fa-1x"></i>My Contents
                    </a></li>
                    <li><a href="./php/personal_page/personal_page&3=insight">
                        <i class="fa fa-line-chart fa-1x"></i>Insight
                    </a></li>
                    <li><a href="./php/personal_page/personal_page&3=bookmark">
                        <i class="fa fa-star fa-1x"></i>Bookmarks
                    </a></li>
                </div>
                <div class="userMenuGroup">
                    <li><a href="./php/personal_page/personal_page&3=account_setting">
                        <i class="fa fa-gear fa-1x"></i>Account Setting
                    </a></li>
                    <li style="display:none;"><a href="./php/personal_page/personal_page&3=message">
