...
<div id="wrapper"> 
    ...
    <aside id="mb-menu_panel" class="visible-mb"><!--mobile panel menu-->
        ...
        <ul class="mb-menu_group">
            <li class="mb-menu_list">
                <i class="fa fa-font fa-1x"></i><a href="<?=$two_depth?>/contents/contents_page.php?cate=artwork">Artwork</a>
            </li>
            <li class="mb-menu_list">
    ...
    <header class="main_header">
        ...
        <nav id="main_gnb" class="hidden-mb-b">
            <ul id="gnb">
                <li class="bigsub">
                    <a href="<?=$two_depth?>/contents/contents_page.php?cate=all" class="bigsub_link">
                        Contents
                    </a>
                    <ul class="sub">
                        <li>
                            <a href="<?=$two_depth?>/contents/contents_page.php?cate=artwork"><i class="fa fa-font fa-1x"></i><p>Artwork</p></a>
                        </li>
                        <li>
        ...
        <button data-tip="Add Contents / Sex" id="addcontent_bt" class="btn hidden-mb-b"><i class="fa fa-plus"></i>Add Contents</button>
        <!--��� ǿ��-->
        <?php
            if($LoginState == true){
