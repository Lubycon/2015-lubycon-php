        ...
        <div id="user_view_main" class="con_main">
            ...
            <ul id="creator_card_wrap">
                <li class="creator_card_in">
                    <div id="bestCreator" class="creators-card">
                        <div class="creator-card-header">
                            <span class="card-label">Creator of The <span class="this-month"><?php echo "1";?></span></span>
                        </div><!--header-->
                        <div class="creator-card-body">
                            ...
                            <div class="creator-info-wrap">
                                <p class="creator-name"><a href=".//personal_page.php?cate=dashboard&usernum=<?=$usercode?>"><?=$username?></a></p>
                                <p class="creator-job"></i><?=$userjob?></p>
                                <p class="creator-location hidden-mb-b"><i class="fa fa-map-marker"></i><?=$usercity?>, <?=$usercountry?></p>
                                <article class="contents-count hidden-mb-b">
                                    <p class="contents-num"><?=$contents_count?></p>
                                    Contents
                                </article>
                            </div>
                        </div><!--body-->
                        ...
                        <div class="creator-card-footer">
                            <ul>
                                <li class="usercontent" data-value="0">
                                    <?php 
                                        echo "<a class='contents-link' href='../contents/viewer.php?cate=artwork&conno=$temp'>";
                                    ?>
