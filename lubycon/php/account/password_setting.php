...
<body ondragstart="return false" onselectstart="return false">
    <section class="message message-wrapper bounceInDown animated">
        ...
        <div class="message-box">
            <article class="main-message">Password Setting</article>
            <article class="sub-message">Please write your password</article>
        </div>
        <div class="message-box">
            ...
            <div class="input-wrapper">
                <label class="label-message">New Password</label>
                <input class="input-message" type="password" data-value="password">
            </div>
            <div class="input-wrapper">
                <label class="label-message">New Password again</label>
                <input class="input-message" type="password" data-value="password">
            </div>
        </div>
        <div class="message-box">
